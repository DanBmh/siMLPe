    ...
    def _get_h36m_files(self):
        ...
        for subject in seq_names:
            ...
            for act in self._actions:
                filename0 = "{0}/{1}/{2}_{3}.txt".format(
                    self._h36m_anno_dir, subject, act, 1
                )
                filename1 = "{0}/{1}/{2}_{3}.txt".format(
                    self._h36m_anno_dir, subject, act, 2
                )
                ...
                fs_sel1, fs_sel2 = find_indices_256(
                    num_frames0,
                    num_frames1,
